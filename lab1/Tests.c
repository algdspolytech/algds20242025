...
void AddElem_Test1()
{
	...
	if (res)
		printf("AddElem_Test1 passed\n");
	else
		printf("AddElem_Test1 failed\n");
...
void ContainsElem_Test2()
{
	...
	if (res)
		printf("ContainsElem_Test2 passed\n");
	else
		printf("ContainsElem_Test2 failed\n");
...
void DoesntContainsElem_Test3()
{
	...
	if (res)
		printf("DoesntContainsElem_Test3 passed\n");
	else
		printf("DoesntContainsElem_Test3 failed\n");
...
void Union_Test4()
{
	...
	if (res)
		printf("Union_Test4 passed\n");
	else
		printf("Union_Test4 failed\n");
...
void AddFewElem_Test5()
{
	...
	if (res)
		printf("AddFewElem_Test5 passed\n");
	else
		printf("AddFewElem_Test5 failed\n");
...
void AddRandomElem_Test6()
{
	...
	if (res)
		printf("AddRandomElem_Test6 passed\n");
	else
		printf("AddRandomElem_Test6 failed\n");
...
void DeleteElem_Test7()
{
	...
	if (res)
		printf("ContainsElem_Test7 passed\n");
	else
		printf("ContainsElem_Test7 failed\n");
...
void DeleteNonExistElem_Test8()
{
	...
	if (res)
		printf("DeleteNonExistElem_Test8 passed\n");
	else
		printf("DeleteNonExistElem_Test8 failed\n");

	free(s);
}

void DeleteEmptyList_Test9()
{
	Set *s = initialization();
	bool res = true;
	...
	if (res)
		printf("ContainsElem_Test9 passed\n");
	else
		printf("ContainsElem_Test9 failed\n");
...
void intersectionSets_Test10()
{
	...
	if (res)
		printf("intersectionSets_Test10 passed\n");
	else
		printf("intersectionSets_Test10 failed\n");
...
void IntersectionEmptySets_Test11()
{
	...
	if (res)
		printf("IntersectionEmptySets_Test11 passed\n");
	else
		printf("IntersectionEmptySets_Test11 failed\n");
...
void UnionEmpty_Test12()
{
	...
	if (res)
		printf("UnionEmpty_Test12 passed\n");
	else
		printf("UnionEmpty_Test12 failed\n");
