...
// Функция добавление узла в бинарное дерево
void insert(TreeNode** root, int value) {
    ...
    while (1) {
        ...
        // Сравнение количества узлов в левом и правом поддеревьях
    ...
    // Обновление количества узлов в пути от вставленного узла к корню
    while (top >= 0) {
