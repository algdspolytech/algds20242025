...
int main() {
	...
	// Вызываем рекурсивную вспомогательную функцию топологической сортировки для каждой вершины
	...
	// Возможна ситуация что такой последовательности не существует поэтому проверим что она была составлена правильно
	int flag = 1;
	for (int i = 0;i < length;i++) {
	...
	// По результатам топологической сортировки и проверки записываем результат в выходной файл
