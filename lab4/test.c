...
// Тест: Вычисление простого выражения с сложением
...
// Тест: Вычисление выражения с вычитанием
...
// Тест: Вычисление выражения с умножением
...
// Тест: Вычисление выражения с делением
...
// Тест: Выражение с одинаковыми числами
void TestFindExpression_SameNumbers_no6() {
    const char* A = "111111"; // Все числа одинаковы
    int B = 111111; // Целевое значение
...
// Тест: Проверка корректного нахождения выражения
...
// Тест: Проверка выражения, которое не может быть найдено
...
// Тест: Поиск выражения для нулевого результата
...
// Тест: Проверка на работу с пустой строкой
