...
// Тест 3: Обновление суммы после вставки
...
// Тест 4: Сумма в диапазоне для пустого дерева
...
// Тест 5: Сумма в диапазоне для одного элемента
...
// Тест 6: Сумма в диапазоне для нескольких элементов
