...
// Тест: Проверка на пустоту пустой очереди
...
// Тест: Проверка на пустоту непустой очереди
...
// Тест: Добавление элемента в пустую очередь
...
// Тест: Удаление элемента из непустой очереди
...
// Тест: Раскраска графа с использованием жадного алгоритма
...
// Тест: Освобождение памяти для матрицы смежности
...
// Тест: Проверка на полноту очереди
...
// Тест: Проверка на полноту неполной очереди
