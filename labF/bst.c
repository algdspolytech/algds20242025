...
// Поиск узла по порядку (k-й наименьший элемент)
...
// Функция для поиска узла с данным ключом и вычисления его порядка
...
// Функция для поиска элемента, порядок которого меньше на K
...
// Функция для вывода дерева по порядку (in-order)
