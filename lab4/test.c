...
void interactiveCreateTree(TreeNode** root) {
    ...
    while (1) {
        ...
        printf("4. Печать дерева (прямой обход)\n");
        printf("5. Печать дерева (симметричный обход)\n");
        printf("6. Печать дерева (обратный обход)\n");
        printf("7. Выход\n");
        ...
        case 4:
            printf("Печать дерева (прямой обход):\n");
            printTreePreOrder(*root, stdout);
            printf("\n");
            break;
        case 5:
            printf("Печать дерева (симметричный обход):\n");
            printTreeInOrder(*root, stdout);
            printf("\n");
            break;
        case 6:
            printf("Печать дерева (обратный обход):\n");
